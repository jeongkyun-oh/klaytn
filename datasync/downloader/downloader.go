...
var (
	...
	maxHeadersProcess = 10        // Number of header download results to import at once into the chain
	maxResultsProcess = 10        // Number of content download results to import at once into the chain
